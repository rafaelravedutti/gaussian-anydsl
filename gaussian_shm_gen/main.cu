...
__global__ __launch_bounds__ (128 * 1 * 1) void lambda_21887() {
    __shared__ double ds_img[938];
    __shared__ double ds_filter[7];
    int image_width_reg = 0;
    int image_height_reg = 0;
...
__global__ __launch_bounds__ (16 * 16 * 1) void lambda_22080(struct_image_5837 _22083_24475, struct_Buffer_5838 _22084_24476, struct_filter_5841 _22085_24477) {
    ...
    double  sum_24538;
    double psum_24538;
    int image_width_reg = _22083_24475.e2;
    int image_height_reg = _22083_24475.e3;
    ...
    l24525: ;
        ...
        for(int i = 0; threadIdx.x + i < blockDim.x + 6; i += blockDim.x) {
            for(int j = 0; threadIdx.y + j < blockDim.y + 6; j += blockDim.y) {
                int idxx = gidx - 3 + i;
                int idxy = gidy - 3 + j;
                if(idxx < image_width_reg && idxy < image_height_reg) {
                    ds_img[(threadIdx.y + j) * 22 + threadIdx.x + i] = _24554[idxy * image_width_reg + idxx];
                }
            }
        }
        ...
        double *adjusted_ds_img = &ds_img[(3 - blockIdx.y * blockDim.y) * 22 + 3 - blockIdx.x * blockDim.x];
    ...
    l24575: ;
        ...
        double* _24576;
        _24576 = &adjusted_ds_img[(_24568 / image_width_reg) * 22 + (_24568 % image_width_reg)];
        #line 65 "impala/gpu_device.impala"
        double _24577;
        _24577 = *_24576;
        #line 65 "impala/gpu_device.impala"
    ...
    l24542: ;
        ...
        #line 100 "shared_memory_access"
        double* i_24549;
        i_24549 = &ds_filter[_24548];
        #line 65 "impala/gpu_device.impala"
        #line 100 "shared_memory_access"
        double* _24558;
        _24558 = &adjusted_ds_img[(_24557 / image_width_reg) * 22 + (_24557 % image_width_reg)];
        #line 70 "impala/gpu_device.impala"
        double _24550;
        _24550 = *i_24549;
        #line 70 "impala/gpu_device.impala"
...
__global__ __launch_bounds__ (16 * 16 * 1) void lambda_22212(double* _22215_24588, struct_image_5837 _22216_24589, struct_Buffer_5838 _22217_24590, struct_Buffer_5838 _22218_24591, struct_filter_5841 _22219_24592) {
    ...
    double  sum_24631;
    double psum_24631;
    int image_width_reg = _22216_24589.e2;
    int image_height_reg = _22216_24589.e3;
    ...
    l24620: ;
        ...
        for(int i = 0; threadIdx.x + i < blockDim.x + 6; i += blockDim.x) {
            for(int j = 0; threadIdx.y + j < blockDim.y + 6; j += blockDim.y) {
                ...
                int idxy = gidy - 3 + j;
                if(idxx < image_width_reg && idxy < image_height_reg) {
                    ds_img[(threadIdx.y + j) * 22 + threadIdx.x + i] = _24644[idxy * image_width_reg + idxx];
                }
            }
        }
    ...
    l24664: ;
        ...
        #line 100 "shared_memory_access"
        double* _24665;
        _24665 = &adjusted_ds_img[(_24659 / image_width_reg) * 22 + (_24659 % image_width_reg)];
        #line 65 "impala/gpu_device.impala"
        double _24666;
        _24666 = *_24665;
        #line 65 "impala/gpu_device.impala"
    ...
    l24634: ;
        ...
        #line 100 "shared_memory_access"
        double* _24648;
        _24648 = &adjusted_ds_img[(_24647 / image_width_reg) * 22 + (_24647 % image_width_reg)];
        #line 65 "impala/gpu_device.impala"
        double _24649;
        _24649 = *_24648;
        #line 65 "impala/gpu_device.impala"
